...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_alisupurov_todoApp-golang_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/tasks": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Автор задачи не найден",
                        "schema": {
                            "$ref": "#/definitions/github_com_alisupurov_todoApp-golang_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        "github_com_alisupurov_todoApp-golang_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "github_com_alisupurov_todoApp-golang_internal_core_transport_http_types.Nullable-string": {
            "type": "object",
            "properties": {
                "set": {
                    "type": "boolean"
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                ...
                "completed_at": {
                    "type": "string",
                    "example": "2026-06-21T21:34:00Z"
                },
                "created_at": {
                    "type": "string",
                    "example": "2026-06-21T21:33:15.393205Z"
                },
                "description": {
                    "type": "string",
                    "example": "2 литра"
